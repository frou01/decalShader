...
{
    internal class ModdedStandardShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            scaleOffset = FindProperty("_InstancedMainScaleOffset", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.VectorProperty(scaleOffset,"Scale/Offset");
